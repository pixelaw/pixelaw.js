...
import {type App, createDialog, type Interaction, type Param, type Pixel, type Position} from "@pixelaw/core"
...
export class DojoInteraction implements Interaction {
    ...
    constructor(engine: DojoEngine, app: App, pixel: Pixel | undefined, color: number) {
        // TODO possible optimization: only generate salt when needed
        // TODO salt can also be the id of this interaction
        this.salt = generateRandomFelt252()
