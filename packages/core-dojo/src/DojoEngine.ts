...
import getParams from "./interaction/params.ts"
...
export class DojoEngine implements Engine {
    ...
    handleInteraction(app: App, pixel: Pixel | undefined, color: number): DojoInteraction {
        ...
        if (!app.plugin) {
            ...
            // Params definition based no the contract function's name and signature
            const params = getParams(this.dojoSetup.manifest, contractName, functionName, false)
