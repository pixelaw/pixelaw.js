...
export function setupWorld(provider: DojoProvider) {
    ...
    const actions_findAreaByPosition = async (snAccount: Account | AccountInterface, position: models.Position) => {
        try {
            return await provider.execute(snAccount, build_actions_findAreaByPosition_calldata(position), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const actions_findAreasInsideBounds = async (snAccount: Account | AccountInterface, bounds: models.Bounds) => {
        try {
            return await provider.execute(snAccount, build_actions_findAreasInsideBounds_calldata(bounds), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const actions_newApp = async (
        ...
        try {
            return await provider.execute(snAccount, build_actions_newApp_calldata(system, name, icon), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const actions_removeArea = async (snAccount: Account | AccountInterface, areaId: BigNumberish) => {
        try {
            return await provider.execute(snAccount, build_actions_removeArea_calldata(areaId), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const paint_actions_fade = async (
        ...
        try {
            return await provider.execute(snAccount, build_paint_actions_fade_calldata(defaultParams), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const paint_actions_interact = async (
        ...
        try {
            return await provider.execute(snAccount, build_paint_actions_interact_calldata(defaultParams), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const paint_actions_putColor = async (
        ...
        try {
            return await provider.execute(snAccount, build_paint_actions_putColor_calldata(defaultParams), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const player_actions_interact = async (
        ...
        try {
            return await provider.execute(snAccount, build_player_actions_interact_calldata(defaultParams), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
    ...
    const snake_actions_move = async (snAccount: Account | AccountInterface, owner: string) => {
        try {
            return await provider.execute(snAccount, build_snake_actions_move_calldata(owner), "pixelaw")
        } catch (error) {
            console.error(error)
            throw error
        }
